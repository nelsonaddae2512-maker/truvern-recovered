...
export async function POST(
  ...
  try {
    ...
    const license =
      await reactivateDeploymentLicense({
        id: licenseId,
        actorUserId,
        reason,
      });
    ...
    const message =
      error instanceof Error
        ? error.message
        : "Failed to reactivate deployment license.";
    ...
    if (
      ...
      return json(409, {
        ok: false,
        error:
          "Deployment license is not suspended.",
      });
    }
    ...
    if (
      ...
      return json(409, {
        ok: false,
        error:
          "Expired deployment licenses cannot be reactivated.",
      });
    }
