...
export const metadata: Metadata = {
  title: "Cookie and tracking notice. | Truvern",
  description:
    "Truvern may use essential cookies and related technologies for authentication, security, product operations, and analytics.",
};
