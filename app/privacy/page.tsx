...
export const metadata: Metadata = {
  title: "Privacy for vendor evidence and governance workflows. | Truvern",
  description:
    "Truvern handles customer, vendor, evidence, and workflow data in support of vendor governance operations.",
};

const sections = [
  "Customer account data",
  "Vendor and assessment data",
      ...
      <section className="grid gap-12 lg:grid-cols-[1fr_0.85fr] lg:items-center">
        <div>
          ...
          <h1 className="mt-6 max-w-5xl text-5xl font-semibold tracking-tight md:text-7xl">
            Privacy for vendor evidence and governance workflows.
          </h1>
