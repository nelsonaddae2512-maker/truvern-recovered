...
export const metadata: Metadata = {
  title: "Security built for governance operations. | Truvern",
  description:
    "Truvern is designed for evidence-backed vendor governance workflows with protected access, review traceability, and release-ready records.",
};

const sections = [
  "Authentication and access controls",
  "Evidence handling and governance context",
  "Review workflow traceability",
  "Verification-ready release records",
];
      ...
      <section className="grid gap-12 lg:grid-cols-[1fr_0.85fr] lg:items-center">
        <div>
          ...
          <h1 className="mt-6 max-w-5xl text-5xl font-semibold tracking-tight md:text-7xl">
            Security built for governance operations.
          </h1>
