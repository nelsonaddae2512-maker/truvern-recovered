...
export const metadata: Metadata = {
  ...
  description:
    "These terms describe the expected use of Truvern’s governance operations platform. Final legal terms should be reviewed by counsel before public launch.",
};
