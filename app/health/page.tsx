...
export const metadata: Metadata = {
  title: "Operational health for governance workflows. | Truvern",
  description:
    "Truvern health information helps customers understand platform availability, workflow readiness, and verification endpoint status.",
};
      ...
      <section className="grid gap-12 lg:grid-cols-[1fr_0.85fr] lg:items-center">
        <div>
          ...
          <h1 className="mt-6 max-w-5xl text-5xl font-semibold tracking-tight md:text-7xl">
            Operational health for governance workflows.
          </h1>
