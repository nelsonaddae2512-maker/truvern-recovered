...
const initialFinalAssessment =
  ...
  return (
    ...
    <section className="sticky top-24 rounded-3xl border border-white/10 bg-white/[0.04] p-4 shadow-2xl shadow-slate-950/40">
      ...
      {!truvernCustomerView ? (
        <div className="mt-6 grid gap-5">
          <CompactSubmittedAnswersPanel
            responses={((assignment as any).response?.responses as any) ?? {}}
