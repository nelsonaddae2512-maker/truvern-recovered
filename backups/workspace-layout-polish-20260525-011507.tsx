...
const initialFinalAssessment =
  ...
  return (
    ...
    <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-5 shadow-2xl shadow-slate-950/40">
...
<div className="mt-5 grid gap-4 lg:grid-cols-3">
  ...
  <div className="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
    ...
    <p className="mt-2 text-sm font-semibold text-white">
      ...
      <div className="hidden mt-6 rounded-3xl border border-white/10 bg-slate-950/30 p-6">
          <p className="text-xs uppercase tracking-[0.3em] text-cyan-200/90">
