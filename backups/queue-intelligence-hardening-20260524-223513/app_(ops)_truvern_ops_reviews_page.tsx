    ...
    <main className="mx-auto max-w-7xl px-6 py-10 text-white">
      ...
      <section className="rounded-3xl border border-cyan-400/20 bg-cyan-400/10 p-6 shadow-[0_0_35px_rgba(34,211,238,0.08)]">
        ...
        <p className="mt-2 max-w-4xl text-sm text-slate-300">
          Operational lane for submitted vendor assessments, due dates, completion percentage, requester, vendor, SLA aging, auto-risk score, findings, reopen requests, remediation follow-ups, and release readiness.
        </p>
      </section>
