...
export default async function VendorsPage() {
  ...
  const inReview = vendors.filter((vendor) => vendor._count.assessments > 0).length;
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-2xl font-black tracking-tight text-white">
              No assessment team? Send the vendor to Truvern.
            </h2>
        ...
        {vendors.length === 0 ? (
          <div className="p-8">
            ...
            <p className="mt-2 text-slate-300">
              Add your first vendor to begin tracking evidence, assessments,
              review posture, and governance outputs.
            </p>
          ...
          <div className="divide-y divide-cyan-400/15">
            {vendors.map((vendor) => {
              ...
              const assessmentsCount = vendor._count.assessments;
              ...
              return (
                <div
                  key={vendor.id}
                  className={`relative grid gap-6 p-6 pl-8 transition before:absolute before:left-0 before:top-0 before:h-full before:w-1 hover:bg-cyan-400/[0.03] xl:grid-cols-[1.35fr_1.4fr_auto] xl:items-center ${rowAccent(score)}`}
                >
                  <div>
...
function Metric({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-2xl border border-cyan-400/10 bg-slate-950/50 p-3 shadow-lg shadow-cyan-950/10">
