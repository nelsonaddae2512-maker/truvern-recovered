...
const initialFinalAssessment =
  ...
  const initialRecommendations =
    remediationConditions.length > 0
      ? remediationConditions.join("\n")
      : generatedFollowUps.length > 0
        ? generatedFollowUps.join("\n")
        : Array.isArray(latestOutcome.conditionsAndFollowUps) &&
          latestOutcome.conditionsAndFollowUps.length > 0
          ? latestOutcome.conditionsAndFollowUps.join("\n")
          : Array.isArray(responsePayload.conditionsAndFollowUps) &&
            responsePayload.conditionsAndFollowUps.length > 0
            ? responsePayload.conditionsAndFollowUps.join("\n")
      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <h3 className="mt-3 text-2xl font-semibold text-white">
            {isTruvern ? "Truvern expert review" : "Self-managed governance review"}
          </h3>
          ...
          <div className="flex flex-col gap-6 xl:flex-row xl:items-start xl:justify-between">
            <div className="max-w-4xl">
              ...
              <h2 className="mt-3 text-3xl font-semibold text-white">
                Governance release finalized into audit history
              </h2>
                      ...
                      {submittedEvidence?.fulfilledEvidenceId ? (
                        <div className="rounded-xl border border-emerald-400/20 bg-emerald-400/10 p-3">
                          ...
                          {submittedEvidence.evidenceUrl ? (
                            <p className="mt-2 break-all rounded-lg border border-white/10 bg-black/20 px-3 py-2 text-xs text-cyan-100">
                              {submittedEvidence.evidenceUrl}
                            </p>
                          ) : null}
                        </div>
...
<div className="mt-5 grid gap-4 lg:grid-cols-3">
  ...
  <div className="rounded-2xl border border-white/10 bg-slate-950/40 p-4">
    ...
    <p className="mt-2 text-sm font-semibold text-white">
      ...
      {activeWorkspaceTab === "release" ? (
        <div className="mt-6 grid gap-6">
              ...
              <div className="mt-6 rounded-3xl border border-cyan-400/20 bg-cyan-500/10 p-6">
                ...
                <h3 className="mt-3 text-2xl font-semibold text-white">
                  Review governance packet before approval
                </h3>
      ...
      <div className="hidden mt-5 rounded-3xl border border-white/10 bg-slate-950/30 p-6">
          <p className="text-[10px] uppercase tracking-[0.28em] text-cyan-200/90">
