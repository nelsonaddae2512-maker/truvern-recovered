        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-2xl font-black tracking-tight text-white">
              Let Truvern manage this vendor assessment.
            </h2>

            <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-300">
              Truvern Ops can send the questionnaire, collect evidence, review
              responses, generate findings, manage remediation, and deliver the
              final governance release package for 1 Truvern credit.
            </p>
          </div>
...
<Link href="/vendors" className="text-sm text-cyan-200">
      ...
      <VendorPortalAccessPanel vendorId={vendor.id} />
<section
        id="start-assessment"
